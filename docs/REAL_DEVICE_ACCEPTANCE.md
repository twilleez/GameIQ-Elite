...
## A. Offline → reconnect
Sign in on Device A, go offline, record and save a short game, then reconnect. Include a made 2, a made top/deep 3, a missed 3, a rebound and an assist. Verify the game stays local while offline, then syncs automatically after reconnect. PM verifies exactly one matching cloud game and matching shots.
